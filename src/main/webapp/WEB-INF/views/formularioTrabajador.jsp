						...
						<div class="col-md-8">
							<div class="card">
								<div class="card-body">
									...
									<p>Para asignar el horario del médico seleccione la
										especialidad del médico, los días que va a trabajar y la hora
							...
							<div class="col-md-6 mb-3 text-left">
								...
								<div class="form-check">
									<input class="form-check-input" type="checkbox" value=""
										...
										for="miercolesLabel"> Miércoles </label>
								</div>
								<div class="form-check">
									<input class="form-check-input" type="checkbox" value=""
	...
	<script type="text/javascript">
		...
		function comprobarValidezHora(hora) {
			...
			if (hora == '') {
				...
				$('#labelHoraMal').html(
						"La hora no es válida, debe estar en formato 00:00");
