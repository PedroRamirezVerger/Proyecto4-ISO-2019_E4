 ...
 * Generated at: 2019-11-26 12:02:10 UTC
...
public final class formularioTrabajador_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t\t<p>Para asignar el horario del médico seleccione la\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tespecialidad del médico, los días que va a trabajar y la hora\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tinicio y hora fin de su jornada laboral.</p>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tPara asignar el horario del médico usted debe seleccionar la\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tespecialidad del médico, los días que va a trabajar y la\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\thora inicio y hora fin de su jornada laboral.\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<label id=\"labelEspecialidadMal\"></label> <br></br> <label\r\n");
      out.write("\t\t\t\t\t\t\tfor=\"diasSemana\">Seleccione los días que va a trabajar</label>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"container center\">\r\n");
      ...
      out.write("\t\t\tdocument.getElementById(\"labelEspecialidadMal\").style.display = 'none';\r\n");
      ...
      out.write("\t\t\tcuenta = comprobarEspecialidad();\r\n");
      ...
      out.write("\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\tfunction comprobarEspecialidad() {\r\n");
      out.write("\t\t\tif (document.getElementById(\"especialidad\").value == \"\") {\r\n");
      out.write("\t\t\t\tdocument.getElementById(\"labelEspecialidadMal\").style.display = 'inline';\r\n");
      out.write("\t\t\t\t$('#labelEspecialidadMal').html(\r\n");
      out.write("\t\t\t\t\t\t\"Debe seleccionar una especialidad\");\r\n");
      out.write("\t\t\t\t$('#labelEspecialidadMal').css(\"color\", \"red\");\r\n");
      out.write("\t\t\t\treturn 1;\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\treturn 0;\r\n");
      out.write("\t\t}\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tconsole\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t.log(document\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t.getElementById(\"especialidad\").value);\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tvar especialidadSelecc = (document\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t.getElementById(\"especialidad\").value);\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tespecialidadSelecc,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tdiasSelecc,\r\n");
